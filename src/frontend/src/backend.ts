...
export class Backend implements backendInterface {
    ...
    async addOrUpdateAPIKey(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateAPIKey(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async customProviderMetadataExists(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.customProviderMetadataExists(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllAPIKeys(): Promise<Array<[Principal, Array<APIKey>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllAPIKeys();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCustomProviderMetadata(): Promise<Array<CustomProviderMetadata>> {
        if (this.processError) {
            try {
    ...
    async getAllProviders(): Promise<Array<ProviderInfo>> {
        if (this.processError) {
            try {
    ...
    async getAllUsersCustomProviderMetadata(): Promise<Array<[Principal, Array<CustomProviderMetadata>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllUsersCustomProviderMetadata();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCustomProviderMetadata(arg0: string): Promise<CustomProviderMetadata | null> {
        if (this.processError) {
            try {
    ...
    async getProviderInfo(arg0: string): Promise<ProviderInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.getProviderInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProviderKey(arg0: string): Promise<APIKey | null> {
        if (this.processError) {
            try {
    ...
    async initializeProviders(arg0: Array<ProviderInfo>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeProviders(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async providerKeyExists(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async setCustomProviderMetadata(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setCustomProviderMetadata(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async streamChatMessages(arg0: string, arg1: bigint): Promise<Array<ChatMessage>> {
        if (this.processError) {
            try {
