        ...
        <div className="space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              By accessing and using Empire C.C, you accept and agree to be
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Permission is granted to temporarily use Empire C.C for personal,
            ...
            <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
              ...
              <li>
                Attempt to reverse engineer any software contained in Empire C.C
              </li>
              <li>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Empire C.C allows you to connect to third-party AI provider
              services using your own API keys. You are solely responsible for:
            </p>
            <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
              <li>
              ...
              <li>
                Compliance with the terms of service of third-party providers
              </li>
              <li>
                Any costs or charges incurred through the use of third-party
                services
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Your data, including API keys, chat history, and workflow runs, is
              stored on the Internet Computer blockchain. While we implement
              security measures to protect your data, you acknowledge that no
              method of transmission over the internet is 100% secure. You are
              responsible for maintaining the security of your Internet Identity
              credentials.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              The materials within Empire C.C are provided on an 'as is' basis.
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              In no event shall Seale's Empire or its suppliers be liable for
              any damages (including, without limitation, damages for loss of
              data or profit, or due to business interruption) arising out of
              the use or inability to use Empire C.C, even if we or our
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              The materials appearing in Empire C.C could include technical,
              typographical, or photographic errors. We do not warrant that any
              of the materials are accurate, complete, or current. We may make
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              We have not reviewed all of the sites linked to Empire C.C and are
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              ...
              By using Empire C.C, you are agreeing to be bound by the then
