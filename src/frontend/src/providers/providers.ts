...
export const PROVIDERS: ProviderConfig[] = [
  {
    ...
    description:
      "Private, unbiased AI — text, images, video, code and characters via Venice's permissionless API",
    icon: Sparkles,
    capabilities: [
      "Text/Chat",
      "Image Generation",
    ...
    route: "/providers/venice-ai",
    workflowType: "chat",
    recommendedPrompts: [
      "Write a detailed script for a 60-second product ad",
      "Generate a high-resolution product image with studio lighting",
      "Create a short cinematic video clip of a mountain sunrise",
      "Write a Python function that processes JSON data",
      "Design an AI character persona for a customer service bot",
    ],
  },
  {
    id: "openai",
  ...
  },
  {
    ...
    optionFields: [
      ...
      },
      {
        ...
        label: "Style",
        type: "select",
        options: ["Cinematic", "Realistic", "Animated", "Abstract"],
    ...
    optionFields: [
      {
        ...
        label: "Scene Prompt",
        type: "textarea",
        placeholder: "Describe the 3D scene...",
      },
      {
        id: "cameraMovement",
        label: "Camera Movement",
        type: "select",
        options: ["Static", "Orbit", "Fly-through", "Dolly"],
        defaultValue: "Orbit",
      },
    ],
    recommendedPrompts: [
  ...
  },
  {
    ...
    optionFields: [
      ...
      },
      {
        ...
        label: "Visual Style",
        type: "select",
        options: ["Realistic", "Artistic", "Anime", "Sketch"],
    ...
    optionFields: [
      {
        ...
        label: "Model",
        type: "select",
        options: ["stable-diffusion-xl-1024-v1-0", "stable-diffusion-v1-6"],
    ...
    optionFields: [
      {
        ...
        defaultValue: "fal-ai/flux-pro",
      },
      {
        id: "prompt",
        label: "Prompt",
        type: "textarea",
        placeholder: "Your main prompt...",
      },
      {
        id: "positivePrompt",
        label: "Positive prompt",
        type: "textarea",
        placeholder: "Elements to emphasize...",
      },
      {
        id: "negativePrompt",
        label: "Negative prompt",
    ...
    optionFields: [
      {
        ...
        label: "Task",
        type: "select",
        options: ["Text-to-Video", "Image-to-Video", "Video Enhancement"],
    ...
    optionFields: [
      {
        ...
        defaultValue: "Leonardo Diffusion XL",
      },
      {
        id: "prompt",
        label: "Image Prompt",
      ...
      },
      {
        ...
        label: "Style Preset",
        type: "select",
        options: ["Leonardo Style", "Anime", "Photorealistic", "Digital Art"],
        defaultValue: "Leonardo Style",
      },
    ],
    recommendedPrompts: [
    ...
    optionFields: [
      {
        ...
        label: "Caption",
        type: "textarea",
        placeholder: "Video caption with hashtags...",
      },
      {
        id: "privacy",
        label: "Privacy",
  ...
  },
  {
    ...
    icon: ShoppingBag,
    capabilities: ["Product Management", "Order Processing", "Inventory"],
    ...
    optionFields: [
      {
        ...
        label: "Action",
        type: "select",
        options: ["Create Product", "Update Inventory", "Process Order"],
    ...
    recommendedPrompts: [
      "Create a new product listing with images and description",
  ...
  },
  {
    ...
    optionFields: [
      {
        ...
        label: "Action",
        type: "select",
        options: ["Create Product", "Update Product", "Get Orders"],
        defaultValue: "Create Product",
      },
      {
        id: "data",
    ...
    recommendedPrompts: [
      ...
      "Generate sales report for the last month",
    ],
  },
  {
    id: "custom-slot-1",
    ...
    description: "Configure your own AI provider or integration",
    icon: Settings,
  ...
  },
  {
    id: "custom-slot-3",
    name: "custom-slot-3",
    displayName: "Custom Slot 3",
    description: "Configure your own AI provider or integration",
    icon: Settings,
    capabilities: ["Custom Integration"],
    route: "/providers/custom-slot-3",
    isCustomSlot: true,
    workflowType: "custom",
    optionFields: [
      {
