...
export const PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    ...
    optionFields: [
      ...
      { id: 'imageSize', label: 'Image Size', type: 'select', options: ['square_hd', 'square', 'portrait_4_3', 'portrait_16_9', 'landscape_4_3', 'landscape_16_9'], defaultValue: 'square_hd' },
    ],
    recommendedPrompts: [
  ...
  },
  {
    ...
    workflowType: 'integration',
    optionFields: [
      { id: 'action', label: 'Action', type: 'select', options: ['Create Product', 'Update Inventory', 'Process Order'], defaultValue: 'Create Product' },
      { id: 'data', label: 'Data (JSON)', type: 'textarea', placeholder: '{"title": "Product Name", ...}' },
    ],
    recommendedPrompts: [
  ...
  },
  {
    ...
    workflowType: 'integration',
    optionFields: [
      { id: 'action', label: 'Action', type: 'select', options: ['Create Product', 'Update Product', 'Get Orders'], defaultValue: 'Create Product' },
      { id: 'data', label: 'Data (JSON)', type: 'textarea', placeholder: '{"name": "Product Name", ...}' },
    ],
    recommendedPrompts: [
  ...
  },
  {
    ...
    workflowType: 'custom',
    optionFields: [
      { id: 'endpoint', label: 'API Endpoint', type: 'text', placeholder: 'https://api.example.com/...' },
      { id: 'payload', label: 'Request Payload (JSON)', type: 'textarea', placeholder: '{"key": "value"}' },
    ],
  },
  {
    id: 'custom-slot-2',
